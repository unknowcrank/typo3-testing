<?php
class Default_action_ToolbarItems_UserToolbarItem_86328ed0e046ae5b extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output6 .= $renderingContext->getViewHelperInvoker()->invoke(TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::class, $arguments11, $renderingContext)
;
...
$output15 .= $renderingContext->getViewHelperInvoker()->invoke(TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::class, $arguments16, $renderingContext)
;
